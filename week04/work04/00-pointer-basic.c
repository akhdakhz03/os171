...
void main(void){
   ...
   printf("ultimate_pointer0: val=%p  adr=%p, pst=%p, ppt=%p, varchar=%c", ultimate_pointer0, &ultimate_pointer0, *ultimate_pointer0, **ultimate_pointer0, ***ultimate_pointer0);
   printf("ultimate_pointer1: val=%p  adr=%p, pst=%p, ppt=%p, varchar=%c", ultimate_pointer1, &ultimate_pointer1, *ultimate_pointer1, **ultimate_pointer1, ***ultimate_pointer1);
   printf("ultimate_pointer2: val=%p  adr=%p, pst=%p, ppt=%p, varchar=%c", ultimate_pointer2, &ultimate_pointer2, *ultimate_pointer2, **ultimate_pointer2, ***ultimate_pointer2);
   printf("ultimate_pointer3: val=%p  adr=%p, pst=%p, ppt=%p, varchar=%c", ultimate_pointer3, &ultimate_pointer3, *ultimate_pointer3, **ultimate_pointer3, ***ultimate_pointer3);
} 